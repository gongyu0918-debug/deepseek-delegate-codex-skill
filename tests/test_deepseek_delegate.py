...
SCRIPT_PATH = ROOT / "scripts" / "deepseek_delegate.py"
MCP_SCRIPT_PATH = ROOT / "scripts" / "deepseek_delegate_mcp.py"
...
class DeepSeekDelegateTests(unittest.TestCase):
    ...
    def test_skill_body_keeps_domain_specific_private_detail_out(self):
        text = SKILL_PATH.read_text(encoding="utf-8")

        self.assertNotIn("C:\\Users", text)
        self.assertNotIn("F:\\Workspaces", text)
        self.assertNotIn("private workflow", text.lower())
